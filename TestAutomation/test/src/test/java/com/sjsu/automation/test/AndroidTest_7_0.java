...
//
 ...
 //"//android.widget.TextView[@text='Automation']")).click();
            driver.findElement(MobileBy.xpath("//android.widget.TextView[@text='Photos']")).click();
            //if allow photos to access
            //TODO always allow
            driver.findElement(MobileBy.xpath("//android.widget.Button[@text='ALLOW']")).click();
